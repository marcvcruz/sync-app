Rails.application.routes.draw do
  ...
  match '/password-reset/:token' => 'password_resets#edit', via: :get, as: :edit_password_reset
  match '/password-reset/:token' => 'password_resets#patch', via: :patch, as: :update_password_reset
