class User < ActiveRecord::Base
  ...
  validates :username,
            ...
            format: { with: /\A[a-z]+[\w\-\.]+\z/i, allow_blank: true, message: :no_spaces_or_special_characters },
            uniqueness: { case_sensitive: false }
  validates :email,
            format: { with: /(?:\A[a-z0-9]+(?:(?:\_|\.)[a-z0-9]+)*@[a-z\d\-\.\_]+\.[a-z]+\z)/i, allow_blank: true, message: :please_use_a_valid_email_address }
  validates :password,
